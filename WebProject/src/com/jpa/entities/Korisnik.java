...
public class Korisnik {
	 ...
	 * @param verifikovan
	 */
	public Korisnik(int id, String username, String password, String ime, String prezime, String telefon,
			String kartica, String paypal, String racun, int stanje, String verifikovan) {
		super();
		this.id = id;
		this.username = username;
		this.password = password;
