...
@Table(name="radnik")
public class Radnik {
	@TableGenerator(name="radnik_gen",table="id_gen",pkColumnName="gen_name",
			valueColumnName="gen_val",allocationSize=1,pkColumnValue="radnik_gen")
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE,generator = "radnik_gen")
	private int id;
